...
During the 2023 survey, sites were that are being considered for replacement were revisited for baseline monitoring. Below is a list of the sites with links to the monitoring results. 

*** Skeena 2021 and BUlkley 2020 report PR's needs to be merged to see 2023 results/links***


- 123377 - Thompson Creek -  Electrofishing was conducted to assess potential impacts of the culvert on fisheries values in the stream with results found [here](https://www.newgraphenvironment.com/fish_passage_skeena_2021_reporting/thompson-creek---198066-123377-123375---appendix.html). Drone (and ortho?) footage was also collected and can be found [here](). 
- 124500 - Helps Creek. Electrofishing was conducted to assess potential impacts of the culvert on fisheries values in the stream with results found [here](https://www.newgraphenvironment.com/fish_passage_bulkley_2020_reporting/appendix-124500-helps-creek.html). Drone (and ortho?) footage was also collected and can be found [here](). 
- 198217 - Tributary to Skeena River. Monitoring results can be found [here](https://www.newgraphenvironment.com/fish_passage_skeena_2022_reporting/tributary-to-skeena-river---198216-198217---appendix.html#conclusion-and-recommendations)
- 198215 - Dale Creek
- 197360 - Riddeck Creek. replacement in process (but stalled) so just monitoring with fish sampling. 
- Gramaphone ?? dip netting, found canyon.
