...
PSCIS crossing `r as.character(my_site)` is located on `r fpr::fpr_my_pscis_info()` approximately `r round(fpr::fpr_my_bcfishpass(col_pull = downstream_route_measure)*0.001, 1)`km upstream of McDonell Lake, on `r fpr_my_pscis_info(col_pull = road_name)`.
...
```{r tab-moti-8543-comments, eval = F}
...
the provincial protocol [@moe2011Fieldassessment] (Table \@ref(tab:tab-culvert-8543)). The culvert was in por condition 
with holes in the bottom and  an outlet drop of 0.5m. 
