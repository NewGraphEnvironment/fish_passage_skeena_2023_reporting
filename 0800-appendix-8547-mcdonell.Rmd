...
`r fpr_my_pscis_info(col_pull = road_name)`. The road at the crossing location is the responsibility of the Ministry of Forests.
...
and prioritized for follow up with ahabitat confirmation in 2024 because of relatively good flow volumes were observed
...
[@moe2011Fieldassessment] (Table \@ref(tab:tab-culvert-8547)) `r if(gitbook_on){knitr::asis_output("(Figure \\@ref(fig:photo-8547-01)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-8547-d01))."))`. Water temperature was
...
`r fpr_my_habitat_paragraph(loc = 'ds2')` There were abundant gravels, few deep pools, and multiple shallow pools up to 20-25cm deep `r if(gitbook_on){knitr::asis_output("(Figure \\@ref(fig:photo-8547-03)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-8547-d02))."))`  
...
`r fpr_my_survey_dist(loc = 'us')`  `r if(gitbook_on){knitr::asis_output("(Figure \\@ref(fig:photo-8547-04)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-8547-d02))."))` `r fpr_my_habitat_paragraph(loc = 'us')` The stream channel was small and moderately steep, 
...
for salmonid rearing and spawning with the site was rated as a `r fpr::fpr_my_priority_info(col_pull = priority) %>% stringr::str_to_lower()` 
