...
interconnected, and that our well-being depends on the health of our environment.
...
were previously documented.  When this occured, past reports for these sites edited and updated with 2023 data.
...
- [Skeena Watershed Fish Passage Restoration Planning 2022](https://newgraphenvironment.github.io/fish_passage_skeena_2021_reporting/)
...
Ten sites where habitat confirmations were conducted in the past were revisited in 2023 to gather data to further inform
prioritization and or to provide data for effectiveness monitoring. Below are sites visited (listed by watershed group)
with details of data collected and links to reporting provided above and within the Results and Discussion section of
this report. Additional data collected primarily included fish sampling data and aerial imagery aquired by remotely piloted aircraft.
...
projects in 2025. Learnings from the successful replacement of crossing 198217 on a tributary to the Skeena River on
Sik-e-dakh Water Tower Road can now be applied to the Zymoetz River watershed group leveraging further funding acquired
by GWA for replacement of a crossing in 2025. At the time of reporting several crossings have been identified as
potential candidates for replacement with funding for one of the sites earmarked from this year's fiscal dollars.
...
from climate change scenarios such as the Canadian Center for Climate Services (CCCS) and the Pacific Climate Impacts
Consortium.
