...
[@moe2011Fieldassessment] (Table \@ref(tab:tab-culvert-8543)). The culvert was in bad condition with holes in the bottom and had an outlet drop of 0.5m. Water temperature was
...
Crossing `r as.character(my_site)` was ranked as a `r fpr::fpr_my_pscis_info(col_pull = barrier_result) %>% stringr::str_to_lower()` to fish passage. The culvert was in bad condition with holes in the bottom and has a significant outlet drop of 0.5m. There are historic fish observations both upstream and downstream of the crossing in the FISS database, and surveyors observed fish upstream of the crossing during the assessment.


Recomend fish sampling.
fish observed during assessent and historic points.
...
```{r photo-8543-02, fig.cap= my_caption1, out.width = photo_width, eval=gitbook_on}
